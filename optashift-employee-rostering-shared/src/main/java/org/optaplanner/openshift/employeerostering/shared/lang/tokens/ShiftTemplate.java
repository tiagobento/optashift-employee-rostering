 ...
 */
@Entity
@NamedQueries({ @NamedQuery(name = "ShiftTemplate.get",
                            query = "select distinct t from ShiftTemplate t" + " where t.tenantId = :tenantId") })
public class ShiftTemplate extends AbstractPersistable {
    ...
    public ShiftTemplate(Integer tenantId,
            EnumOrCustom baseDateType,
            EnumOrCustom repeatType,
